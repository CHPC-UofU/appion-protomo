...
$html .= "
<br />
<center><H4>Tilt-Series Reconstruction After Protomo Coarse Alignment</H4></center>
<br />";
if (isset($rec_gif_files[0]) and isset($rec_gif_files[1]) and isset($manual_rec_gif_files[1])) {
	...
	$html .= '<center><b>Manual</b></center>
		  ...
		  <source src="'.$manual_rec_mp4.'" type="video/mp4" loop>'.'<br />
		  <source src="'.$manual_rec_webm.'" type="video/webm" loop>'.'<br />
		  <source src="'.$manual_rec_ogv.'" type="video/ogg" loop>'.'<br />
		  HTML5 video is not supported by your browser.
		  </video></center>';
	$html .= '<center><b>Iteration 2</b></center>
...
$html .= "<br></br><b><center>[If you wish to manually align, run the following command:</b><br><br>
		...
		Possible '<i>--iteration</i>' options are: Original, Coarse, Coarse2, Imod, or Manual<br>
		If there are bad images (contamination, missed target, etc.), you should remove them by adding a comma-separated list after '<i>--exclude_angles=</i>'.<br>
		You may remove high-tilt images by using the '<i>--negative=</i>' and '<i>--positive=</i>' options; e.g. <i>--negative=-45.5 --positive=45.5</i> will remove all tilts greater than 45 degrees.<br>
		You may also wish to change the <i>center_all_images</i>, <i>sampling</i>, or <i>max_image_fraction</i> options.<br>
		Add '<i> --create_videos</i>' to make tilt-series and reconstruction videos of your manual alignment.</center></b><br>";
