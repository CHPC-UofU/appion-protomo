...
class TransferCtfResults(appionScript.AppionScript):
	...
	def start(self):
		...
		for imgdata in images:
			...
			print 'micrograph/' + imgdata['filename'] + '.mrc', ctfdata['defocus1']*10**10, ctfdata['defocus2']*10**10, ctfdata['angle_astigmatism'], '300.000 0.01000 0.07000 10000.0000 1.10000', ctfdata['confidence']
			if not ctfdata:
