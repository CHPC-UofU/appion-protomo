...
if (isset($rec_gif_files[0])) {
	$html .= '<center><img src="'.$rec_gif.'" alt="correlations" /></center>';
		...
		$html .= "<br><br><b><center>[If you wish to manually align from the this alignment iteration or to just restart from this iteration, run the following command:</b><br><br>
			...
			<b>and then select the 'Starting Alignment' as Manual]</center></b><br>";
} else {
